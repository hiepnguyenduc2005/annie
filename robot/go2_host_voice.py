"""Compatibility shim: this module moved to `robot.dog.voice.host_voice` (2026-09-20 cleanup). Import the new path."""
import sys as _sys
from pathlib import Path as _Path

_sys.path.insert(0, str(_Path(__file__).resolve().parents[1]))  # repository root
import robot.dog.voice.host_voice as _module  # noqa: E402
