...
VIEWER_PATH = Path(__file__).with_name("spacetime_viewer.html")
THREE_LOCAL_PATH = Path(__file__).with_name("three.min.js")  # optional vendored r128 for offline (robot hotspot) use
