...
from robot.dog.runtime.patrol import (TOPIC_LIDAR_SWITCH, TOPIC_VOXELS, _default_conn_factory, _encode)  # noqa: E402
from robot.dog.link.probe import extract_lowstate, extract_pose, safe_error  # noqa: E402
from robot.dog.planning.smart_patrol import (PatrolPlanner, StallDetector, body_frame, quaternion_yaw, sector_ranges,  # noqa: E402
                              voxel_points_world)
...
def _speak_blocking(text: str) -> bool:
    ...
    from robot.dog.runtime.patrol import speak_blocking
